...
<template>
  <main class="meetings-page container mx-auto px-4 pt-32 pb-12">
    <header class="mx-auto mb-8 max-w-4xl text-center">
      <div class="page-hero-badge">
        <span class="page-hero-badge__dot" />
        <span>Jadwal Kegiatan JuruTani</span>
        <span class="page-hero-badge__sweep" aria-hidden="true" />
      </div>

      <h1 class="page-hero-title">
        Meetings &amp; Webinar<br />
        <span class="page-hero-title__accent">Pertanian Tani</span>
      </h1>
