...
<template>
  <main class="food-prices-page container mx-auto px-4 pt-32 pb-12 app-reveal">
    <!-- Hero Section -->
    <header class="mx-auto mb-12 max-w-4xl text-center">
      <div class="page-hero-badge">
        <span class="page-hero-badge__dot" />
        <span>Informasi Harga Terkini</span>
        <span class="page-hero-badge__sweep" aria-hidden="true" />
      </div>

      <h1 class="page-hero-title">
        Harga Pangan<br />
        <span class="page-hero-title__accent">DIY Terkini</span>
      </h1>
